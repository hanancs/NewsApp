...
const Technology = () => {
  ...
  const goForAxios = async () => {
    await axios.get(`https://newsapi.org/v2/everything?q=technology&apiKey=c3761b65071340fe87d1ac28053e68b3&page=${scrollIndex}&pageSize=10`)
      .then(response => {
        setLoading(false);
  ...
  const fetchNextItems = async () => {
    if (scrollIndex <= 9) {
      ...
      const response = await axios.get(`https://newsapi.org/v2/everything?q=technology&apiKey=c3761b65071340fe87d1ac28053e68b3&page=${scrollIndex + 1}&pageSize=10`);
